    ...
    public partial class bondFinder : Form
    {
        ...
        private void pullCORP()
        {
            ...
            if (usingSQLServer == true)
            {
                ...
                if (sheet.Cells[1,1] == null || sheet.Cells[1, 1].Value2 == null || sheet.Cells[1, 1].Value2.ToString() == "")
                {
                    sheet.Cells[1, 1].Value2 = "Template:";
                    sheet.Cells[1, 2].Value2 = "Street Pull";
                }
                ...
                while (rdr.Read())
                {
                    if (useHeaders == true)
                    {
                        for (int x = 0; x < colName.Length; x++)
                        {
                            ...
                            for (int z = 0; z < rdr.FieldCount; z++)
                            {
                                if (rdr.GetName(z).Equals(colName[x], StringComparison.InvariantCultureIgnoreCase))
