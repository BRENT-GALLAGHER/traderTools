     ...
     //"' and criteria_descriptor='Range'";
      ...
      //}
       ...
       public void fillMBSClient()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               string SQL = "select distinct  rtrim(ltrim(CLIENT))  as client from  [FicmAnalytic].[dbo].cmospreadsheet " +
       ...
       public void fillMBSTicker()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               string SQL = "select distinct  rtrim(ltrim(CRITERIA_VALUE)) from  [FicmAnalytic].[dbo].SearchCriteria " +
       ...
       public void fillMBSTypeList()
      {
          ...
          if (usingSQLServer == true)
          {
              ...
              cn.Open();
              SqlCommand cmd = new SqlCommand();
              string SQL = "if  OBJECT_ID('FicmAnalytic.dbo.inventoryCriteriaSaved" +
              ...
              if (Rdr.GetValue(0).ToString().Equals("0"))
              {
                  ...
                  cmd = cn.CreateCommand();
                  cmd.CommandText = "create table FicmAnalytic.dbo.InventoryCriteriaSaved (criteria_sector char(25)," +
              ...
              //---GETTING TYPE
              SQL = "select distinct  rtrim(ltrim(blm_sector)) from  [FicmAnalytic].[dbo].cmospreadsheet where sector='MBS';";
             // SQL = "select distinct  rtrim(ltrim(type)) from  [FicmAnalytic].[dbo].cmospreadsheet where sector='MBS';";
              cmd = cn.CreateCommand();
              //SqlDataReader Rdr;
              ...
              //SQL = "select distinct  rtrim(ltrim(CRITERIA_VALUE)) from  [FicmAnalytic].[dbo].SearchCriteria " +
              //    " where criteria_sector='MBS' and criteria_SearchBox='mbsTicker';";
              //cmd = cn.CreateCommand();
              ...
              //**** FILL CLIENT LIST ***//
              //SQL = "select distinct  rtrim(ltrim(CLIENT))  as client from  [FicmAnalytic].[dbo].cmospreadsheet " +
              //     " where sector='MBS' order by CLIENT;";
              //cmd = cn.CreateCommand();
       ...
       public void fillMuniStateList()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               cmd.CommandText = "delete from InventoryCriteriaSaved where criteria_sector='MUNI'" +
                   ...
                   " (select distinct  rtrim(ltrim(State)) from  [FicmAnalytic].[dbo].munilookup);";
               ...
               //---GETTING State
               SQL = "select rtrim(ltrim(State)), count(*) as frq from  [FicmAnalytic].[dbo].munilookup " +
                   " group by state;";
               cmd = cn.CreateCommand();
       ...
       public void fillMuniTypeList()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               //---GETTING Type
               SQL = "select rtrim(ltrim(Type)), count(*) from  [FicmAnalytic].[dbo].munilookup group by Type;";
               cmd = cn.CreateCommand();
       ...
       public void fillMuniMoodyList()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               //---GETTING Moody
               SQL = "select rtrim(ltrim(Moody)), count(*) from  [FicmAnalytic].[dbo].munilookup group by Moody;";
               cmd = cn.CreateCommand();
       ...
       public void fillMuniSPList()
       {
           ...
           if (usingSQLServer == true)
           {
               ...
               //---GETTING SP
               SQL = "select rtrim(ltrim(S_P)), count(*) from  [FicmAnalytic].[dbo].munilookup group by S_P;";
               cmd = cn.CreateCommand();
      ...
      public void fillCMOcriteraiList_OLD()
      {
          ...
          if (usingSQLServer == true)
          {
              ...
              string SQL = "if  OBJECT_ID('FicmAnalytic.dbo.tmp_CMO_criteria" + userID +
                  "', 'U') is null select '0' else select '1';";
              cmd = cn.CreateCommand();
              SqlDataReader Rdr;
      ...
      public void fillClientcriteraiList()
      {
          ...
          if (usingSQLServer == true)
          {
              ...
              string SQL = "if  OBJECT_ID('FicmAnalytic.dbo.tmp_Client_criteria" + userID + 
                 "', 'U') is null select '0' else select '1';";
             cmd = cn.CreateCommand();
             SqlDataReader Rdr;
      ...
      private void initializeCMOCriterialist()
      {
          ...
          if (usingSQLServer == true)
          {
              ...
              cn.Open();
              SqlCommand cmd = new SqlCommand();
              string SQL = "select distinct  rtrim(ltrim(CRITERIA_field)) from  [FicmAnalytic].[dbo].InventoryCriteriaSaved " +
                  " where criteria_sector='MBS' and criteria_SearchName='" + MBSSearchescomboBox.Text.ToString() +
                  "' and criteria_Descriptor='Range';";
              cmd = cn.CreateCommand();
